...
public class WATUT
{
    ...
    public WATUT() {
        ...
        MinecraftForge.EVENT_BUS.register(new ModParticles());

        IEventBus modBus = FMLJavaModLoadingContext.get().getModEventBus();
        modBus.addListener(ModParticles.FactoryHandler::registerFactories);
        modBus.addListener(EventHandlerForge::registerParticles);
        modBus.addListener(EventHandlerForge::getRegisteredParticles);
