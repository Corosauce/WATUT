...
public class ItemPickupParticleSprite extends Particle {
   ...
   public ItemPickupParticleSprite(EntityRenderDispatcher p_107023_, RenderBuffers p_107024_, ClientLevel p_107025_, Entity p_107026_, Entity p_107027_) {
      this(p_107023_, p_107024_, p_107025_, p_107026_, p_107027_, p_107026_.getDeltaMovement());
   }

   private ItemPickupParticleSprite(EntityRenderDispatcher p_107029_, RenderBuffers p_107030_, ClientLevel p_107031_, Entity p_107032_, Entity p_107033_, Vec3 p_107034_) {
   ...
   private void thing() {
      ItemStack itemStack = new ItemStack(Items.ACACIA_LOG);
      /*Pair<ResourceLocation, ResourceLocation> pair = itemStack.getItem().getNoItemIcon();
      if (pair != null) {
   ...
   public ParticleRenderType getRenderType() {
      return ParticleRotating.CUSTOM;
   }
